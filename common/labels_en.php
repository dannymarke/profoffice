...
define("PROFILO_AZIENZA","Profile");
define("CERTIFICAZIONI","CERTIFICATIONS");
define("CERTIFICAZIONI_AZIENDA","Certifications");
define("AMBIENTE","ENVIRONMENT");
define("AMBIENTE_AZIENDA","Environment");
define("CONSULENZA","ADVISING");
define("CONSULENZA_AZIENDA","Advising");
define("VIDEO","VIDEO");
...
define("ALTRO","Other");
define("TESTO","Text:");
define("CONTATTI_UFFICI","Site, offices, and showroom:");
define("CONTATTI_INDICAZIONI","Road maps");
...
define("DESC_AREA_RISERVATA","The \"login/register\" area allows to download the catalogues. It is necessary to fill in the form you will find in this page. When registering, you consent to get Prof newsletter. In order to revoke your assent, you have to use the \"UNSUBSCRIBE\" key quoted in any newsletter. The use of the downloaded texts and images from this website is allowed only if Prof is mentioned.");
define("REFERENZE_TESTO","SELECT A CONTINENT TO SEE OUR REFERENCES:");
define("REFERENZE_EUROPA","EUROPE");
define("REFERENZE_ASIA","ASIA");
define("REFERENZE_AMERICA","NORTH AMERICA");
define("REFERENZE_AMERICA_SUD","SOUTH AMERICA");
define("REFERENZE_AFRICA","AFRICA");
define("REFERENZE_OCEANIA","OCEANIA");
define("CERTIFICAZIONE_TESTO", "Confirming its care for the quality, Prof S.r.l. got UNI EN ISO 9001:2008 certification and it observes the International quality rules in the design, development, manufacture and cusomers' assistance. The certification allows Prof S.r.l. to answer for the sector and markets regulation demandes.<br /><br />Moreover, Prof S.r.l. has always paid special attention to the environment introducing UNI EN ISO 14001:2004 certification attesting it.");
define("CERTIFICAZIONE_SCARICA", "Download our certifications:");
