            ...
            <div id="main_body_wr">
                ...
                <section id="main_content_wr">
                  <div id="left_wr">
                    <div id="news_scroller_wr">
                      <ul id="news_scroller_list">
                        ...
                        ?>
                          <li>
                            <a rel="/news/slimPreview.jpg?<?php echo $row['id']?>" href="/news/dettaglio/<?php echo $row['id']?>">
                  ...
                  <div id="right_wr" class="dyn_bg_wr">
                      ...
                      <img src="/news/showroom.jpg" alt="" id="press_preview_image" class="img_seo_placeholder">
                  </div>
                </section>
            </div>
        </div>
