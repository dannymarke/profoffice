<?php include_once "includes/conditional-init.php"; ?>
    <head>
        ...
        <title>Prof office - <?php echo(strtoupper(AZIENDA));?> - <?php echo(strtoupper(AMBIENTE));?></title>
        ...
        <div id="main_wr">
            ...
            <div id="main_body_wr">
                ...
                <section id="main_content_wr" class="bg_zoom dyn_bg_wr">
                    <img src="/img/main_azienda_ambiente.jpg" alt="image name" id="Azienda - profilo" class="img_seo_placeholder">
                    <article class="content_wr" style="right: 50px; top:126px; width:450px; color: #000000;">
                        <h2 class="content_title" style="font-size:15px;"><strong><?php echo(AMBIENTE_AZIENDA);?></strong></h2>
