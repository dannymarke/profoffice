        ...
        <div id="main_wr">
            ...
            <div id="main_body_wr">
                ...
                <section id="main_content_wr" class="bg_zoom dyn_bg_wr">
                    ...
                    <article class="content_wr" style="right: 50px; top:120px; width:450px; color: #000000;">
                        <h2 class="content_title" style="font-size:13px;"><strong><?php echo(AMBIENTE_AZIENDA);?></strong></h2>
