                    ...
                    <ul>
                        <li>
                            <a href="/azienda"><?php echo(strtoupper(AZIENDA));?></a>
                            <ul>
                                <li><a href="/azienda/profilo"><?php echo(strtoupper(PROFILO));?></a></li>
                                <li><a href="/azienda/certificazioni"><?php echo(strtoupper(CERTIFICAZIONI));?></a></li>
